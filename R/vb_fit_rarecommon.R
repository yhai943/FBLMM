...
#' @param weight.type type of weight function (uw, beta, wss)
...
#' data <- read_file(gene_file = paste(datafile,"snp.bed",sep="/"),y_file = paste(datafile,"y.txt",sep="/"))
#' y = data$y
...
#' fit <- vb_fit_rarecommon(y = y, genotype0 = genotype0, weight.type = "wss")
